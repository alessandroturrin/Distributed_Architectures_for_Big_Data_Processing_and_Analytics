...
public class DriverBigData extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		MultipleOutputs.addNamedOutput(job, "hightemp", TextOutputFormat.class, NullWritable.class, Text.class);
		MultipleOutputs.addNamedOutput(job, "normaltemp", TextOutputFormat.class, NullWritable.class, Text.class);
